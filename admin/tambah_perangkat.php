                ...
                <div class="col-xl-9 ms-2">
                    <div class="card-body">
                        ...
                        <div class="mb-5 mt-4">
                            ...
                            <a href="data_perangkat.php"><button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg ms-2"><i class="bi bi-arrow-return-left me-2"></i>Kembali</button></a>
                        </div>
                    </div>
                </div>
            </form>
